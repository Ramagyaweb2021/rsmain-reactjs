...
const ScholarshipProgramme = () => {
  ...
  return (
    <>
      ...
      <link rel="canonical" href="https://ramagyaschool.com/fee-structure" />
      </Head>
      <Header />
          ...
          <div className="col-md-3 col-6 mb-4">
            <div className="card text-center h-100 border-0">
              <div className="card-value-body">
                ...
                <p>
                  <a
                    href="https://forms.edunexttechnologies.com/forms/ramagyanoida/Registration-new/"
                    target="_blank"
          ...
          <div className="col-md-3 col-6 mb-4">
            <div className="card text-center h-100 border-0">
              <div className="card-value-body">
                ...
                <p>
                  <a
                    href="https://forms.edunexttechnologies.com/forms/ramagyanoidaextension/registration/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn btn learn-more-button"
                  >
