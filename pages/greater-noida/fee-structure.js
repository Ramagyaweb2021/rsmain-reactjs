...
import FeeStructureTablenGreaterNoida from '../components/FeeStructureTablenGreaterNoida';
import TransportationFeeGreaterNoida from '../components/TransportationFeeGreaterNoida';
...
const FeeStructure = () => {
  ...
  return (
    <>
          ...
          <div className="col-lg-8 col-12 mx-auto d-flex align-items-center">
            <div className='fee-procedure-detail'>
              <h3 className='main-heading-internal-pages'>NOIDA GREATER</h3>
                ...
                <p><b>Gate No. 1, Ramagya World School, NS-26, Delta-2, Greater Noida, Uttar Pradesh – 201310 Uttar Pradesh</b></p>
              ...
              <div className="d-flex justify-content-left align-items-left mt-1">
                <div className="learn-more-button">
                  <a href="https://ramagyagn.edunexttechnologies.com/DirectStudentOnlineFee" target="_blank">Pay Now</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <FeeStructureTablenGreaterNoida/>
      <TransportationFeeGreaterNoida/>
      <FooterGreaterNoida />
    </>
  );
};
