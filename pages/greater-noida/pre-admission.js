...
import GreaterNoidaAdmissionScrollspyMenu from '../components/GreaterNoidaAdmissionScrollspyMenu';
// import ApplyNowSectionGreaterNoida from '../components/ApplyNowSectionGreaterNoida';
import PreAdmissionDeviderSectionGreaterNoida from '../components/PreAdmissionDeviderSectionGreaterNoida';
...
const PreAdmission = () => {
  ...
  return (
    <>
      ...
      <GreaterNoidaAdmissionScrollspyMenu />
      ...
      <PreAdmissionDeviderSectionGreaterNoida />
      {/* Appointment section */}
          ...
          <div className="col-md-12">
            <div className="text-left mb-5">
              <div className='about-content'>
                ...
                <p style={{ textAlign: "center" }}>Please do not hesitate to reach out to us via email at <b> (admissions.greaternoida@ramagyaschool.com)</b> or by calling us at <b>+91-7065-078-637</b>. Additionally, you have the option to schedule an appointment with the admissions team for a direct meeting, ensuring a smooth and trouble-free admission process for your child.</p>
          ...
          <div className="col-md-3 col-6 mb-4">
            <div className="card text-center h-100 border-0">
              <div className="card-value-body">
                ...
                <p>
                  <a
                    href="https://vtourgnoida.ramagyaschool.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn btn learn-more-button"
                  >
          ...
          <div className="col-md-3 col-6 mb-4">
            <div className="card text-center h-100 border-0">
              <div className="card-value-body">
                ...
                <p>
                  <a
                    href="https://drive.google.com/file/d/1v7kxSIuezXOlP8BtzsTZLUgYdRt4cuPN/view"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn btn learn-more-button"
                  >
          ...
          <div className="col-md-12">
            <div className="text-left mb-5">
              <div className='about-content'>
                ...
                <p style={{ textAlign: "center" }}>For any query related to post-admission procedure contact-  <b>+91 7065-078-637</b> </p>
