...
const NoidaExtensionScrollspyHomePageTabination = () => {
  useEffect(() => {
    ...
    <div>
      ...
      {/* <div data-bs-spy="scroll" data-bs-target="#tabNavbar" data-bs-offset="120"> */}
        ...
        <section id="important-links" className="bg-image-section my-5 py-5">
          ...
          <NoidaExtensionHomePageImportantLinks />
        </section>
      </div>
    </div>
  );
...
export default NoidaExtensionScrollspyHomePageTabination;
