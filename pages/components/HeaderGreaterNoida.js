          ...
          <ul className="navbar-nav justify-content-center flex-grow-0 pe-3">
               ...
               <li className="nav-item dropdown dropend">
                ...
                <li className="nav-item dropdown dropend">
                 ...
                 <li className="nav-item dropdown dropend">
                  ...
                  <ul className="dropdown-menu dropdown-menu-dark">
                    ...
                    <li>
                      <a className="dropdown-item" href="/greater-noida/post-admission">
                        Post Admission
                      </a>
                    </li>
                    <li>
                      <a className="dropdown-item" href="/greater-noida/fee-structure">
                        Fee Structure
                      </a>
                    </li>
                    {/* <li>
                ...
                <li className="nav-item">
                  <a className="nav-link" aria-current="page" href="/greater-noida/parents">
                    Parent&#39;s
                  </a>
                </li>
                  {/*News Feed */}
                  ...
                  <ul className="dropdown-menu dropdown-menu-dark">
                  <li>
                      <a className="dropdown-item" href="https://ramagyaschoolblog.com/category/achievements-greater-noida/" target='_blank'>
                        Achievements
                      </a>
                    </li>
                  <li>
