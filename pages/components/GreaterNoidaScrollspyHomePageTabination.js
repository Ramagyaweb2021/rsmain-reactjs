...
import GreaterNoidaSchoolUpdates from "./GreaterNoidaSchoolUpdates";
import NoidaAwardsHomePage from "./NoidaAwardsHomePage";
import NoidaHomePageInfographics from "./NoidaHomePageInfographics";
import GreaterNoidaHomePageImportantLinks from "./GreaterNoidaHomePageImportantLinks";
import GreaterNoidaPrincipalNote from "./GreaterNoidaPrincipalNote";

const GreaterNoidaScrollspyHomePageTabination = () => {
  useEffect(() => {
    ...
    <div>
      ...
      {/* <div data-bs-spy="scroll" data-bs-target="#tabNavbar" data-bs-offset="120"> */}
        ...
        <section id="important-links" className="bg-image-section my-5 py-5">
          ...
          <GreaterNoidaHomePageImportantLinks />
        </section>
      </div>
    </div>
  );
...
export default GreaterNoidaScrollspyHomePageTabination;
