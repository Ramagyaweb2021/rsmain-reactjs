...
const PreAdmissionDeviderSectionNoidaExtension = () => {
        ...
        >
          ...
          >
            <Button variant="light-1" className="fw-bold" onClick={handleShow}>
              ...
              <Image src="/images/fi_phone-call.webp" alt="" width={20} height={20} /> +91 - 8010 770 770
            </Button>
          </Col>
        </Row>
      </Container>
...
export default PreAdmissionDeviderSectionNoidaExtension;
