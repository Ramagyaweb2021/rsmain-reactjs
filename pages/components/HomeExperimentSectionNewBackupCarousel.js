...
// import InnovateHomeSlider1 from './InnovateHomeSlider1';
// import InnovateHomeSlider2 from './InnovateHomeSlider2';
// import InnovateHomeSlider3 from './InnovateHomeSlider3';
// import InnovateHomeSlider2 from './InnovateHomeSlider2';
const HomeExperimentSection = () => {
  const [activeCategory, setActiveCategory] = useState('category1');
  return (
    <>
    <div className="fp-section-tableExperiment">
