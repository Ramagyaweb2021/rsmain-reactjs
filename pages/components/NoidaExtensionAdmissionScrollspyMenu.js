        ...
        <Row>
          <Col xs={12} className="d-flex justify-content-center col-12">
            <Nav className="bg-dark p-1">
              <Nav.Link href="/noida-extension/pre-admission" className={`mx-2 ${router.pathname === '/noida-extension/pre-admission' ? 'active' : ''}`}>
                PRE-ADMISSION
              </Nav.Link>
              <Nav.Link href="/noida-extension/post-admission" className={`mx-2 ${router.pathname === '/noida-extension/post-admission' ? 'active' : ''}`}>
                POST-ADMISSION
              </Nav.Link>
              <Nav.Link href="/noida-extension/fee-structure" className={`mx-2 ${router.pathname === '/noida-extension/fee-structure' ? 'active' : ''}`}>
                FEE STRUCTURE
              </Nav.Link>
