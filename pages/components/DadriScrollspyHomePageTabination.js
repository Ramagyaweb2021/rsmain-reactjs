...
import DadriPrincipalNote from "./DadriPrincipalNote";
import DadriHomePageImportantLinks from "./DadriHomePageImportantLinks";
import DadriSchoolUpdates from "./DadriSchoolUpdates";
import NoidaAwardsHomePage from "./NoidaAwardsHomePage";

const DadriScrollspyHomePageTabination = () => {
  useEffect(() => {
...
export default DadriScrollspyHomePageTabination;
