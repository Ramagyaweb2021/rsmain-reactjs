...
const NoidaVideoGalleryInternalPage = () => {
  const [activeTab, setActiveTab] = useState('All');
  const [isVideoModalOpen, setIsVideoModalOpen] = useState(false);
  const [currentIndex, setCurrentIndex] = useState(0);

  const videoTabs = [
    'All', 'Celeb Buzz', 'Feedback Corner', 'Academia', 'Sports Galore', 'Beyond Academics',
    'Athletic Center', 'Outdoor Fun', 'Co-Curricular Activities', 'Skill Boosting Sessions',
    'Reading Fiesta', 'Wellness & Support', 'Parent Testimonials', 'Student testimonials',
    'Event Spotlight', 'Change Makers', 'Evolve Video'
  ];
...
export default NoidaVideoGalleryInternalPage;
