...
export const NoidaSchoolAwardsInternalPageSchool = () => {
  const awards = [
    ...
    { name: 'ECC', img: '/images/awards/ecc.webp' },
    { name: 'Award Level 1', img: '/images/awards/award-l1.webp' },
    { name: 'Award Level 2', img: '/images/awards/award-l2.webp' },
    { name: 'Award Level 3', img: '/images/awards/award-l3.webp' },
    { name: 'Award Level 4', img: '/images/awards/award-l4.webp' },
    { name: 'Award Level 5', img: '/images/awards/award-l5.webp' },
    { name: 'Award Level 6', img: '/images/awards/award-l6.webp' },
