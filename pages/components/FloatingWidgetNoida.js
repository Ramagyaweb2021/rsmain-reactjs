  ...
  return (
    <>
      ...
      <div className="floating-widget">
        ...
        <a href="tel:+918010333555" target="_blank" className="social-btn phone" data-label="Calling">
            <FaPhone />
          </a>
          <a href="https://qr1.be/ZJ68" target="_blank" className="social-btn support" data-label="Digital Assistant">
            <FaSuperpowers />
          </a>
          <a href="https://www.youtube.com/c/RamagyaSchoolNoida50" target="_blank" className="social-btn youtube" data-label="YouTube">
            <FaYoutube />
          </a>
          <a href="https://www.facebook.com/RamagyaSchoolNoida/" target="_blank" className="social-btn facebook" data-label="Facebook">
            <FaFacebookF />
          </a>
          <a href="https://x.com/ramagya_school" target="_blank" className="social-btn twitter" data-label="Twitter">
            <FaTwitter />
          </a>
          <a href="https://www.instagram.com/ramagya.school/" target="_blank" className="social-btn instagram" data-label="Instagram">
            <FaInstagram />
          </a>
          <a href="https://in.linkedin.com/school/ramagya-school/" target="_blank" className="social-btn linkedin" data-label="LinkedIn">
            <FaLinkedinIn />
          </a>
          <a href="https://wa.me/+918010151151" target="_blank" className="social-btn whatsapp" data-label="WhatsApp">
            <FaWhatsapp />
          </a>
