      ...
      <p className='text-center'>&ldquo;Ramagya&ldquo; as a name embodies the idea of guiding students toward <b>inner wisdom and enlightenment</b>, <br/> blending traditional Indian ethos with modern education.</p>
        ...
        <div className="row text-center py-5">
          <div className="col-md-4 border-right">
            ...
            <p className="medium">In Sanskrit, &ldquo;Ra&ldquo; is often associated with light, the sun, and illumination. It signifies the source of life.</p>
          </div>
          <div className="col-md-4 border-right">
            <h5 className='ramagya-legacy'>MA (मा)</h5>
            <p className="fw-semibold">My</p>
            <p className="medium">In Sanskrit and several Indian languages, &ldquo;Ma&ldquo; represents “my,” showing care and belonging.</p>
          </div>
          <div className="col-md-4">
            <h5 className='ramagya-legacy'>GYA (ज्ञ)</h5>
            <p className="fw-semibold">Inner Voice</p>
            <p className="medium">&ldquo;Gya&ldquo; symbolizes knowledge, insight, wisdom and learning.</p>
          </div>
        </div>
      </div>
      ...
      <div className="our-brand-essence">
        <div className="container">
          <h5 className="ramagya-legacy text-center text-white mb-5">
            OUR BRAND ESSENCE: <span className="text-yellow"> &ldquo;ARISE. AWAKE. ATTAIN.&ldquo;</span>
          </h5>
          ...
          <div className="row justify-content-center align-items-center mb-4 text-center text-md-start">
            ...
            <div className="col-md-6">
              <p className="text-white">Step up to the challenge. Begin your journey with determination and purpose.</p>
            </div>
          </div>
          ...
          <div className="row justify-content-center align-items-center mb-4 text-center text-md-start">
            ...
            <div className="col-md-6">
              <p className="text-white">Be open to possibilities. Be fully aware and conscious in your growth.</p>
            </div>
          </div>
          ...
          <div className="row justify-content-center align-items-center text-center text-md-start">
            ...
            <div className="col-md-6">
              <p className="text-white">Realize your potential. Reach your goals and dreams with excellence.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          ...
          <div className="row justify-content-center align-items-center mb-4 text-center text-md-start">
            <div className="col-md-12">
              ...
              At Ramagya School, every day is a fresh page in the journey of our students—one lled with
              curiosity, growth, and self-discovery.</p>

              <p className="text-white text-center">As the morning sun rises, so do their aspirations, shining brightly with the pursuit of
              knowledge. Each open book is not just a textbook, but a gateway to dreams, innovation,
              and new possibilities.</p>

              <p className="text-white text-center">The red banner that proudly displays Ramagya School is more than just a name; it’s a
              ...
              <p className="text-white text-center">The circular badge they wear over their hearts is more than an emblem—it’s a symbol of
              ...
              <p className="text-white text-center">At Ramagya, we are not just shaping bright minds; we are nurturing bright futures. With
          ...
          <div className="row justify-content-center align-items-center mb-4 text-center text-md-start">
            <div className="col-md-12">
              <p className="text-black text-center">
                  ...
                  <p className="text-black text-center">Our philosophy is rooted in the timeless essence of Manubharva, the responsibility of
                  ...
                  <p className="text-black text-center">With a foundation built on values, discipline, and holistic learning, Ramagya shapes future
